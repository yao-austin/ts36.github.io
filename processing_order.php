            ...
            <div class="col-md-12">
                <div class="card mt-5">
                    <div class="card-header">
                        <h1 class="text-center">正在處理的訂單共<i class="text-info"><?php echo $row;?></i> 筆</h1>
                    </div>
                    <div class="card-body">
...
$select_order = mysqli_query($conn, "SELECT * FROM `orders` where status='訂單準備中' ORDER BY id DESC"); 
if($select_order)
{

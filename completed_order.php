            ...
            <div class="col-md-12">
                <div class="card mt-5">
                    <div class="card-header">
                        <h1 class="text-center">完成的訂單共<i class="text-info"><?php echo $row;?></i> 筆</h1>
                    </div>
                    <div class="card-body">
						<div class="btn-group">
...
$select_order = mysqli_query($conn, "SELECT * FROM `orders` where status='訂單已完成' ORDER BY id DESC"); 
if($select_order)
{

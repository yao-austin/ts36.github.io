            ...
            <div class="col-md-12">
                <div class="card mt-5">
                    <div class="card-header">
                        <h1 class="text-center">等待處理的訂單共<i class="text-info"><?php echo $row;?></i> 筆</h1>
                    </div>
                    <div class="card-body">
                        <div class="btn-group">
...
<table class="table table-bordered" style="background-color: white;">
	<thead class="table-dark">
		<tr>
			...
			<th> <i class="fas fa-user" style="font-size:20px,width:"></i>名字</th>
			<!--
			<th class="d-block"> <i class="fas fa-phone" style="font-size:20px"></i>電話號碼</th>
		-->
...
$select_order = mysqli_query($conn, "SELECT * FROM `orders` where status='等待回應中' ORDER BY id DESC"); 
if($select_order)
{
